...
class ZhihuAccount(object):
    ...
    def __init__(self, username: str = None, password: str = None):
        self.temp_path = os.path.abspath(os.path.dirname(os.path.dirname(__file__))) + '/temp/'
    ...
    def _get_captcha(self, lang: str):
        ...
        if show_captcha:
            ...
            with open(self.temp_path + 'captcha.jpg', 'wb') as f:
                f.write(base64.b64decode(img_base64))
            img = Image.open(self.temp_path + 'captcha.jpg')
            if lang == 'cn':
    ...
    def _encrypt(form_data: dict):
        ...
        with open(file_path + '/encrypt.js') as f:
