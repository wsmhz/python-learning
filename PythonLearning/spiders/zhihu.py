...
class ZhihuSpider(scrapy.Spider):
    ...
    def parse_question(self, response):
        ...
        yield scrapy.Request(self.start_answer_url.format(question_id, 20, 0),cookies=self.cookies, headers=self.headers, callback=self.parse_answer)
        yield question_item
    ...
    def start_requests(self):
        return [scrapy.Request('https://www.zhihu.com', headers=self.headers, callback=self.check_login)]
